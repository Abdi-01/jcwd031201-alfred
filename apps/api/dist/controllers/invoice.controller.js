...
const content_1 = require("../templates/content");
    ...
    updateInvoice(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (addRecurringDate) {
                    newNextInvoiceDate = new Date(date);
                    const offsetMinutes = 7 * 60;
                    newNextInvoiceDate.setMinutes(newNextInvoiceDate.getMinutes() + offsetMinutes);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const invoice of selectedInvoices) {
                    ...
                    yield page.setContent((0, content_1.content)(invoice), { waitUntil: 'networkidle0' }); // Wait until the network is idle (optional)
    ...
    sendInvoice(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const browser = yield puppeteer_1.default.launch();
                const page = yield browser.newPage();
                yield page.setContent((0, content_1.content)(findInvoice));
